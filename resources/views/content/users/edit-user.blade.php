...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{ route('user-users-list') }}">Users</a> /</span>
        Edit User</h4>
    <div class="row">
        <!-- Basic -->
        <div class="col-md-12">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('user-update') }}" method="post" id="userForm">
                            ...
                            <div class="col-md-10">
                                <div class="form-check form-check-inline mt-3">
                                    <input class="form-check-input" type="radio" name="user_type" id="user_type1"
                                        value="1" {{ $user->access_type == 1 ? 'checked' : '' }} />
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="user_type" id="user_type2"
                                        value="2" {{ $user->access_type == 2 ? 'checked' : '' }} />
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-check form-check-inline mt-3">
                                    <input class="form-check-input" type="radio" name="user_status" id="user_status1"
                                        ...
                                        {{ $user->id == auth()->user()->id && auth()->user()->access_type == 1 ? 'disabled' : '' }} />
                        ...
                        <div class="mb-3" style="text-align: center;">
                            <button type="button" class="btn btn-warning" id="formSubmitBtn">Update User</button>
                        </div>
                    </form>
                </div>
            </div>
