...
@section('content')
    {{-- <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a
                href="{{ route('retailer-retailers-list') }}">Retailers</a> /</span> Create Retailer</h4> --}}
    <div class="row">
        <!-- Basic -->
        <div class="col-md-12">
            <div class="card mb-4">
                <h5 class="card-header">Create New Retailer</h5>
                <div class="card-body">
                    @include('notification')
                    <form action="{{ route('createRetailer') }}" method="post" id="retailerForm"
                        ...
                        <div class="mb-3 row">
                            <label for="formFile" class="col-md-2 col-form-label">Logo <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-10">
                                ...
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                  ...
                                  <a href="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/1024px-No_image_available.svg.png" data-lightbox="image-1" id="popupImage"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/1024px-No_image_available.svg.png" alt="No Image" class="d-block rounded" id="uploadedAvatar" height="100" width="100"></a>
                              </div>
                            ...
                            <div class="col-md-10">
                                <div class="form-check form-check-inline mt-3">
                                    <input class="form-check-input" type="radio" name="broadband" id="broadband1"
                                        value="1" {{ old('broadband') == "1" ? 'checked' : '' }}/>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="broadband" id="broadband2"
                                        value="0" {{ old('broadband') == "0" ? 'checked' : '' }}/>
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-check form-check-inline mt-3">
                                    <input class="form-check-input" type="radio" name="retailer_status"
                                        id="retailer_status1" value="Yes" checked />
                        ...
                        <div class="mb-3 row">
                            <label for="tncText" class="col-md-2 col-form-label">T&C Text <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <textarea name="tncText" id="tncText" class="form-control" autocomplete="off">{{old('tncText')}}</textarea>
                                @error('tncText')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3" style="text-align: center;">
                            <button type="button" class="btn btn-warning" id="formSubmitBtn">Create Retailer</button>
                        </div>
                    </form>
                </div>
            </div>
